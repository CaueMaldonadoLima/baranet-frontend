        ...
        <div className="rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold text-white">Baranet Admin</h1>
              <p className="text-white/60 text-sm mt-0.5">Acesso restrito à equipe interna</p>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  autoComplete="email"
                  placeholder="admin@baranet.com.br"
